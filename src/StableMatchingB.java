...
public class StableMatchingB implements StableMatchingInterface {
	int[][] men;
	int[][] women;
	...
	public int[][] constructStableMatching(int[] menGroupCount, int[] womenGroupCount, int[][] menPrefs,
		...
		StableMatchingB SM = new StableMatchingB(m, w); // everyone is unengaged at beginning
